  ...
  const contactInfo = [
    {
      ...
      title: "Адрес",
      details: ["г. Москва, ул. Ленина, 123", "Бизнес-центр «Технополис», офис 456"],
    },
    {
  ...
  const faqItems = [
    {
      ...
      answer: "Создание сервера происходит автоматически и занимает не более 5 минут после оплаты.",
    },
    {
    ...
    },
    {
      ...
      answer: "Да, мы предоставляем тестовый период на 3 дня для всех тарифных планов.",
    },
    {
      ...
      <div className="pt-36 pb-16">
        <div className="container mx-auto px-4">
                ...
                {faqItems.map((item, index) => (
                  <SwiperSlide key={index}>
                    <div className="bg-[#0f1f4b] rounded-lg p-8">
                      <h3 className="text-xl md:text-2xl font-bold mb-4">{item.question}</h3>
            ...
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div>
                  ...
                  <div className="mt-8 bg-[#0f1f4b] p-6 rounded-lg">
                    ...
                    <div className="flex gap-4">
                      <a href="#" className="bg-[#4f46e5]/10 p-3 rounded-full hover:bg-[#4f46e5]/20 transition-colors">
                        <svg
                ...
                <div>
                  ...
                  <form onSubmit={handleSubmit} className="bg-[#0f1f4b] p-6 rounded-lg">
                    <div className="space-y-4">
                      <div>
                        ...
                        <Input
                          ...
                          className="bg-[#0a1a40] border-[#0a1a40] text-white"
                      ...
                      <div>
                        ...
                        <Select>
                          <SelectTrigger className="bg-[#0a1a40] border-[#0a1a40] text-white">
                            <SelectValue placeholder="Выберите тему обращения" />
                          </SelectTrigger>
                          <SelectContent className="bg-[#0f1f4b] border-[#0a1a40]">
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={handleChange}
                          className="bg-[#0a1a40] border-[#0a1a40] text-white min-h-[150px]"
                          placeholder="Введите ваше сообщение"
                          required
                        />
                      </div>

                      <Button type="submit" className="w-full bg-[#4f46e5] hover:bg-[#4f46e5]/90">
                        Отправить сообщение
                      </Button>
                    </div>
                  </form>
          ...
          <div className="py-16 bg-[#0f1f4b]">
            <div className="container mx-auto px-4">
              <h2 className="text-3xl font-bold text-center mb-8">Наш офис на карте</h2>

              <div className="bg-[#0a1a40] h-[400px] rounded-lg flex items-center justify-center">
                <p className="text-white/50">Здесь будет карта с расположением офиса</p>
              </div>
            </div>
          </div>
        </div>
